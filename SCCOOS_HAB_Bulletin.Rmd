...
Cal_Poly_Nutrient_Plot = 
  ...
  scale_x_date(
    limits = as.Date(c("2018-01-01","2018-11-31")),
...
ggsave(file="Cal_Poly_Nutrient_Plot.png", plot=Cal_Poly_Nutrient_Plot, width=10, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Nutrient_plots") 
```
...
Newport_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=14))
ggsave(file="Newport_Pier_Nutrient_Plot.png", plot=Newport_Nutrient_Plot, width=10, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Nutrient_plots") 
...
Santa_Cruz_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Cruz_Nutrient_Plot.png", plot=Santa_Cruz_Nutrient_Plot, width=10, height=8,path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Nutrient_plots")
```
...
Santa_Monica_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Monica_Nutrient_Plot.png", plot=Santa_Monica_Nutrient_Plot, width=11, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Nutrient_plots")
...
Stearns_Wharf_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Sterns_Wharf_Nutrient_Plot.png", plot=Stearns_Wharf_Nutrient_Plot, width=10, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Nutrient_plots") 
...
Cal_Poly_HAB_Plot = 
  ...
  labs(title= "Cal Poly Pier HAB and DA Data", 
       ...
       color = "")+
  scale_x_date(
    limits = as.Date(c("2018-01-01","2018-11-30")),
    labels= date_format("%b %y"),
    date_breaks = "months")+
  theme_bw()+
  theme(
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/plots")
...
save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/plots")
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/plots")
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_10/plots")
...
save_plot("Stearns_Wharf_Combo_Plot.png",Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/plots")
