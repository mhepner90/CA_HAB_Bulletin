...
```{r December 2018 CDPH data}

Pn_2018_12_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/2018_12_week_1_Pn.csv") #27x11  
Pn_2018_12_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/2018_12_week_2_Pn.csv") #21x11
Pn_2018_12_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/2018_12_week_3_Pn.csv") #21x11 
Pn_2018_12_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/2018_12_week_4_Pn.csv") #18x11

CDPH_2018_12 = dplyr::bind_rows(Pn_2018_12_wk1, Pn_2018_12_wk2) 
CDPH_2018_12 = dplyr::bind_rows(CDPH_2018_12, Pn_2018_12_wk3) #
CDPH_2018_12 = dplyr::bind_rows(CDPH_2018_12, Pn_2018_12_wk4) #87x11

CDPH_Pn_2018_12 = CDPH_2018_12 %>% #
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Pn_2018_12, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/CDPH_Pn_2018_12.csv")

CDPH_Pn_2018_12_max = CDPH_Pn_2018_12 %>%  
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
...
write_csv(CDPH_Pn_2018_12_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2018_12/CDPH_Pn_2018_12_max.csv")

Al_2018_12_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/2018_12_week_1_Al.csv") #10 
Al_2018_12_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/2018_12_week_2_Al.csv") #11 
Al_2018_12_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/2018_12_week_3_Al.csv") #5
Al_2018_12_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/2018_12_week_4_Al.csv") #5 

CDPH_2018_12 = dplyr::bind_rows(Al_2018_12_wk1, Al_2018_12_wk2) #23x12
CDPH_2018_12 = dplyr::bind_rows(CDPH_2018_12, Al_2018_12_wk3) #29x12
CDPH_2018_12 = dplyr::bind_rows(CDPH_2018_12, Al_2018_12_wk4) #38x12

CDPH_Al_2018_12 = CDPH_2018_12 %>%
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Al_2018_12, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/CDPH_Al_2018_12.csv")

CDPH_Al_2018_12_max = CDPH_Al_2018_12 %>% 
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
...
write_csv(CDPH_Al_2018_12_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2018_12/CDPH_Al_2018_12_max.csv")
...
ggsave(file="TMMC_Monthly_Average_2018_12.png", width=10, height =6 , path="/Volumes/GoogleDrive/My Drive/SCCOOS/TMMC/Plots")
```
...
Cal_Poly_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/CalPoly_Pier_2018_12.csv") 
...
write_csv(Cal_Poly,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Cal_Poly_cleanedup.csv")

#Newport  
Newport_Org = read_csv("HABMAP_Data/Newport.csv") #orignial Stearn Wharf HABMAP data from google drive 
...
Santa_Cruz_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Santa_Cruz_2018_12.csv") 
...
Santa_Cruz = Santa_Cruz_Org %>% #353x10
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Santa_Cruz,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Santa_Cruz_cleanedup.csv")
...
Santa_Monica_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Santa_Monica_2018_12.csv")
##need to remove tbd from Cholorophyll and 
...
Santa_Monica = Santa_Monica_Org %>% #353x10
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Santa_Monica,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Santa_Monica_cleanedup.csv")

#Stearns Wharf 
#Stearn_Wharf_Org = read_csv("HABMAP_Data/Stearn_Wharf.csv") #orignial Stearn Wharf HABMAP data from google drive
Stearn_Wharf_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Stearns_Wharf_2018_12.csv")
...
Stearn_Wharf = Stearn_Wharf_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Stearn_Wharf,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Stearn_Wharf_cleanedup.csv")

#Scripps Pier
Scripps_Pier_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Scripps_Pier_2018_12.csv")
...
Scripps_Pier = Scripps_Pier_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Scripps_Pier,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/data/Scripps_Pier_cleanedup.csv")
...
ggsave(file="Cal_Poly_Nutrient_Plot.png", plot=Cal_Poly_Nutrient_Plot, width=20, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots") 
```
...
Newport_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=14))
ggsave(file="Newport_Pier_Nutrient_Plot.png", plot=Newport_Nutrient_Plot, width=20, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots") 
...
Santa_Cruz_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Cruz_Nutrient_Plot.png", plot=Santa_Cruz_Nutrient_Plot, width=20, height=8,path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots")
```
...
Santa_Monica_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Monica_Nutrient_Plot.png", plot=Santa_Monica_Nutrient_Plot, width=20, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots")
...
Stearns_Wharf_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Sterns_Wharf_Nutrient_Plot.png", plot=Stearns_Wharf_Nutrient_Plot, width=20, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots") 
...
Scripps_Pier_Nutrient_Data = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Scripps_Pier_Nutrient_Plot.png", plot=Scripps_Pier_Nutrient_Data, width=20, height=8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/Nutrient_plots") 
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
...
save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
...
Santa_Monica_HAB_Plot = 
  ...
  labs(title= "Santa Monica Pier HAB and DA Data",  
       ...
       color = "")+
  scale_x_date(
    limits = as.Date(c("2018-01-01","2018-10-30")),
    labels= date_format("%b %y"),
    date_breaks = "months")+
  theme_bw()+
  theme(
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
...
save_plot("Stearns_Wharf_Combo_Plot.png",Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
...
save_plot("Scripps_Pier_Combo_Plot.png",Scripps_Pier_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_12/HAB_plots")
```
