...
#CDPH_Pn_2019_03 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_03/CDPH_2019_03_Pn.csv")

CDPH_Pn_2019_03 = CDPH_Pn_2019_03 %>% #
...
CDPH_Pn_2019_03_max = CDPH_Pn_2019_03 %>%  
...
write_csv(CDPH_Pn_2019_03_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_03/CDPH_Pn_2019_03_max.csv")
...
CDPH_Al_2019_03 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_03/CDPH_2019_03_Al.csv")

CDPH_Al_2019_03 = CDPH_Al_2019_03 %>%
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Al_2019_03, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_03/CDPH_Al_2019_03.csv")

CDPH_Al_2019_03_max = CDPH_Al_2019_03 %>% 
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
  arrange(percent_composition_max) #24x4
write_csv(CDPH_Al_2019_03_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_03/CDPH_Al_2019_03_max.csv")
...
ggsave(file="TMMC_Monthly_Average_2019_03.png", width=10, height =6 , path="/Volumes/GoogleDrive/My Drive/SCCOOS/TMMC/Plots")
...
ggsave(file="Stranding_Counts_2019_03.png", width=10, height =6 , path="/Volumes/GoogleDrive/My Drive/SCCOOS/TMMC/Plots")
...
Cal_Poly_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/2019_03_Cal_Poly_Pier.csv") 
...
write_csv(Cal_Poly,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/Cal_Poly_cleanedup.csv")

#Newport  
Newport_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/2019_03_Newport_Pier.csv") 
...
Newport = Newport_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Newport,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/Newport_cleanedup.csv")

#Santa Cruz 
Santa_Cruz_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/2019_03_Santa_Cruz.csv") 
...
Santa_Cruz = Santa_Cruz_Org %>% #353x10
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Santa_Cruz,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/Santa_Cruz_cleanedup.csv")
...
write_csv(Santa_Monica,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/Santa_Monica_cleanedup.csv")

#Stearns Wharf 
Stearn_Wharf_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/2019_03_Stearns_Wharf.csv")
...
Stearn_Wharf = Stearn_Wharf_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Stearn_Wharf,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/Stearn_Wharf_cleanedup.csv")

#Scripps Pier
Scripps_Pier_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HABMAP_data/2019_03_Scripps_Pier.csv")
...
Scripps_Pier = Scripps_Pier_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"), #Silicate
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
...
save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
...
Santa_Monica_HAB = Santa_Monica %>%
  filter(Year %in% c("2018","2019")) %>% #Keep all 2018 and 2019 data 
  filter(!(Month == "01" & Year == "2018")) %>% #remove Jan 2018 
  filter(!(Month =="02" & Year == "2018")) %>% #remove Feb 2019  
  mutate(Pn_delicatissima = as.integer(Pn_delicatissima),
         Pn_seriata = as.integer(Pn_seriata),
         Alexandrium = as.integer(Alexandrium),
         Domoic_Acid = as.integer(Domoic_Acid)) %>% 
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
...
Stearns_Wharf_HAB = Stearn_Wharf %>% 
  filter(Year %in% c("2018","2019")) %>% #Keep all 2018 and 2019 data 
  filter(!(Month == "01" & Year == "2018")) %>% #remove Jan 2018 
  filter(!(Month =="02" & Year == "2018"))%>% #remove
  select(Date,Pn_delicatissima, Pn_seriata, Alexandrium, Domoic_Acid)%>%
...
save_plot("Stearns_Wharf_Combo_Plot.png",Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
...
save_plot("Scripps_Pier_Combo_Plot.png",Scripps_Pier_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_03/HAB_plots")
```
