...
Pn_2019_05_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/2019_05_week_1_Pn.csv") 
Pn_2019_05_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/2019_05_week_2_Pn.csv") 
Pn_2019_05_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/2019_05_week_3_Pn.csv")
Pn_2019_05_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/2019_05_week_4_Pn.csv") 

CDPH_Pn_2019_05 = dplyr::bind_rows(Pn_2019_05_wk1, Pn_2019_05_wk2) 
CDPH_Pn_2019_05 = dplyr::bind_rows(CDPH_Pn_2019_05, Pn_2019_05_wk3) 
CDPH_Pn_2019_05 = dplyr::bind_rows(CDPH_Pn_2019_05, Pn_2019_05_wk4) 

#CDPH_Pn_2019_05 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/2019_05_Pn.csv")

CDPH_Pn_2019_05 = CDPH_Pn_2019_05 %>% #
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Pn_2019_05, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/CDPH_Pn_2019_05.csv")

CDPH_Pn_2019_05_max = CDPH_Pn_2019_05 %>%  
...
write_csv(CDPH_Pn_2019_05_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_05/CDPH_Pn_2019_05_max.csv")

Al_2019_05_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/2019_05_week_1_Al.csv")  
Al_2019_05_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/2019_05_week_2_Al.csv")  
Al_2019_05_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/2019_05_week_3_Al.csv")  
Al_2019_05_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/2019_05_week_4_Al.csv")  

CDPH_2019_05 = dplyr::bind_rows(Al_2019_05_wk1, Al_2019_05_wk2) 
CDPH_2019_05 = dplyr::bind_rows(CDPH_2019_05, Al_2019_05_wk3) 
CDPH_2019_05 = dplyr::bind_rows(CDPH_2019_05, Al_2019_05_wk4) 

#CDPH_2019_05 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/2019_05_Al.csv")

CDPH_Al_2019_05 = CDPH_2019_05 %>%
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Al_2019_05, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/CDPH_Al_2019_05.csv")

CDPH_Al_2019_05_max = CDPH_Al_2019_05 %>% 
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
  arrange(percent_composition_max) #24x4
write_csv(CDPH_Al_2019_05_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_05/CDPH_Al_2019_05_max.csv")
...
ggsave(file="Stranding_Counts_2019_05.png", width=10, height =6 , path="~/Google Drive File Stream/My Drive/SCCOOS/CA_HAB_Bulletin/Strandings_Data/Plots")
...
write_csv(Cal_Poly,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/CPP_cleanedup.csv")
...
Newport = Newport_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Newport,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/NPP_cleanedup.csv")
...
Monterey = Monterey_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Monterey,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/MW_cleanedup.csv")
...
Santa_Cruz = Santa_Cruz_Org %>% #353x10
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Santa_Cruz,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/SCW_cleanedup.csv")
...
write_csv(Santa_Monica,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/SMP_cleanedup.csv")
...
Stearn_Wharf = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HABMAP_data/SW_cleanedup.csv")
...
Cal_Poly_HAB_Plot = 
  ...
  labs(title= "Cal Poly Pier HAB and DA Data", 
       ...
       color = "")+
  scale_x_date(
    limits = as.Date(c("2018-05-01","2019-05-31")),
    labels= date_format("%b %y"),
    date_breaks = "months")+
  theme_bw()+
  theme(
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
...
save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
...
save_plot("Stearns_Wharf_Combo_Plot.png",Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
...
save_plot("Monterey_Pier_Combo_Plot.png",Monterey_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_05/HAB_plots")
```
Parsed with column specification:cols(
  Location = col_character(),
