...
Newport_HAB_Pot = 
  ...
  scale_color_manual(
    labels =c(expression(paste(italic("Pseudo-nitzschia")," 'delicatissima' size class (cells/L)")),
              expression(paste(italic("Pseudo-nitzschia")," 'seriata' size class (cells/L)")),
              expression(paste(italic("Alexandrium")," spp. (cells/L)"))), 
    values =c("hotpink","dodgerblue","limegreen"))+
  scale_x_date(
    labels= date_format("%b %y"),
    date_breaks = "months")+
  labs(title= "New Port Pier HAB and DA Data", x="", y="cells/L", color = "")+
  theme_bw()+
  theme(
    plot.margin = unit(c(0, 0, 0, 0), "cm"),
    legend.position = c(0.75,0.8), #c(0.85,0.9)
...
Santa_Cruz_HAB_Plot = 
  ...
  scale_x_date(
    labels= date_format("%b %y"),
    date_breaks = "months")+
  labs(title= "Santa Cruz Municipal Wharf HAB and DA Data", x="", y="cells/L", color = "")+
  theme_bw()+
  theme(
    plot.margin = unit(c(0, 0, 0, 0), "cm"),
    legend.position = c(0.75,0.8), #c(0.85,0.9)
...
#Santa Monica Pier 
Santa_Monica = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2018_11/Santa_Monica.csv")
...
Santa_Monica_HAB_Plot = 
  ...
  scale_x_date(
    labels= date_format("%b %y"),
    date_breaks = "months")+
  labs(title= "Santa Monica Pier HAB and DA Data", x="", y="cells/L", color = "")+
  theme_bw()+
  theme(
    plot.margin = unit(c(0, 0, 0, 0), "cm"),
    legend.position = c(0.75,0.8), #c(0.85,0.9)
...
Stearns_Wharf_HAB_Plot = 
  ...
  scale_x_date(
    labels= date_format("%b %y"),
    date_breaks = "months")+
  labs(title= "Stearns Wharf HAB and DA Data", x="", y="cells/L", color = "")+
  theme_bw()+
  theme(
    plot.margin = unit(c(0, 0, 0, 0), "cm"),
    legend.position = c(0.75,0.8), #c(0.85,0.9)
