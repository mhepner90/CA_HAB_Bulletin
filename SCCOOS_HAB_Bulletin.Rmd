...
Stearns_Wharf_Nutrient_Plot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Sterns_Wharf_Nutrient_Plot.png", plot=Stearns_Wharf_Nutrient_Plot, width=14, height=6) #path="2018_10/plots"
...
Cal_Poly_HAB_Plot = 
  ...
  #scale_y_continuous(sec.axis = sec_axis(~., name = "ng/mL"))+
  scale_y_continuous(
    limits=c(0,300000),
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Cal_Poly_HAB_Plot.png", plot=Cal_Poly_HAB_Plot, width=14, height=6) #path="2018_10/plots"
...
Newport_HAB_Pot = 
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Newport_HAB_Pot.png", plot=Newport_HAB_Pot, width=14, height=6) #path="2018_10/plots"
...
#max(Santa_Cruz_HAB$`Pseudo-nitzschia_delicatissima_group_cells/L`) #209692
...
Santa_Cruz_HAB_Plot = 
  ...
  scale_y_continuous(
    ...
    breaks=c(0,25000,50000,75000,100000,125000,150000,175000,200000,225000,250000,275000,300000),
    labels=c("0","","50,000","","100,000","","150,000","","200,000","","250,000","","300,000"))+
  labs(title= "Santa Cruz Municipal Wharf", x="Date", y="cells/L", color = "")+
  theme_bw()+
  theme(
    legend.position = c(0.85,0.9),
    legend.text = element_text(size=12),
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Cruz_HAB_Plot.png", plot=Santa_Cruz_HAB_Plot, width=14, height=6) #path="2018_10/plots"
...
Santa_Monica_HAB_Plot = 
  ...
  scale_y_continuous(
    ...
    breaks=c(0,25000,50000,75000,100000,125000,150000,175000,200000,225000,250000,275000,300000),
    labels=c("0","","50,000","","100,000","","150,000","","200,000","","250,000","","300,000"))+
  labs(title= "Santa Monica Pier", x="Date", y="cells/L", color = "")+
  theme_bw()+
  theme(
    legend.position = c(0.85,0.9),
    legend.text = element_text(size=12),
    ...
    plot.title = element_text(hjust=0.5),
    title=element_text(size=12))
ggsave(file="Santa_Monica_HAB_Plot.png", plot=Santa_Monica_HAB_Plot, width=14, height=6) #path="2018_10/plots"
...
Stearns_Wharf_HAB_Plot = 
  ...
  geom_point(aes(y=`Pseudo-nitzschia_delicatissima_group_cells/L`, color="Pseudo-nitzschia 'delicatissima' size class (cells/L)"),size=3, color="dodgerblue")+
  geom_point(aes(y=`Pseudo-nitzschia_seriata_group_cells/L`,color="Pseudo-nitzschia 'seriata' size class (cells/L)"),size=3, color="hotpink")+
  scale_y_continuous(
    limits=c(0,300000),
    breaks=c(0,25000,50000,75000,100000,125000,150000,175000,200000,225000,250000,275000,300000),
    labels=c("0","","50,000","","100,000","","150,000","","200,000","","250,000","","300,000"))+
...
Stearns_Wharf_DA_Plot = 
  ggplot(Stearns_Wharf_HAB, aes(x=date))+
  geom_point(aes(y=`Domoic_Acid_ng/mL`, color="Domic Acid (ng/mL)"),size=3,color="limegreen")+
  labs(title= "Stearns Wharf", x="Date", y="ng/mL", color = "")+
...
plot2 = grid.arrange(Stearns_Wharf_HAB_Plot, Stearns_Wharf_DA_Plot, nrow=2)
...
ggsave(file="Stearns_Wharf_HAB_Plot.png", plot=Stearns_Wharf_HAB_Plot, width=14, height=6) #path="2018_10/plots"
