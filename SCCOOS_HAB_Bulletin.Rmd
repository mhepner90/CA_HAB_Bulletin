...
#CDPH_Pn_2019_04 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_04/2019_04_Pn.csv")

CDPH_Pn_2019_04 = CDPH_Pn_2019_04 %>% #
...
CDPH_Pn_2019_04_max = CDPH_Pn_2019_04 %>%  
...
write_csv(CDPH_Pn_2019_04_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_04/CDPH_Pn_2019_04_max.csv")
...
CDPH_Al_2019_04 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_04/2019_04_Al.csv")

CDPH_Al_2019_04 = CDPH_Al_2019_04 %>%
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Al_2019_03, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_03/CDPH_Al_2019_03.csv")

CDPH_Al_2019_04_max = CDPH_Al_2019_04 %>% 
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
  arrange(percent_composition_max) #24x4
write_csv(CDPH_Al_2019_04_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_04/CDPH_Al_2019_04_max.csv")
...
ggsave(file="TMMC_Monthly_Average_2019_04.png", width=10, height =6 , path="/Volumes/GoogleDrive/My Drive/SCCOOS/TMMC/Plots")
...
TMMC_Monthly_Plot2 = ggplot(TMMC_Monthly_Mean, aes(x= Month, y=Monthly_mean))+
  ...
  geom_line(aes(y=`CaWildlife_Center_2019`), color="green", lwd = 1)+
  geom_point(aes(y=`CaWildlife_Center_2019`), color="green", size=5)+
...
ggsave(file="Stranding_Counts_2019_04.png", width=10, height =6 , path="/Volumes/GoogleDrive/My Drive/SCCOOS/TMMC/Plots")

TMMC_Monthly_Plot3 = ggplot(TMMC_Monthly_Mean, aes(x= Month, y=Monthly_mean))+
  geom_line(aes(y=Monthly_mean), lwd = 1)+
  geom_point(aes(y=Monthly_mean), size=3)+
  geom_errorbar(aes(ymax=Monthly_mean+Monthly_se, ymin=Monthly_mean-Monthly_se, color=""), width=0.1, color="grey0")+
  geom_point(aes(y=`TMMC_2019`), size=5)+
  geom_point(aes(y=`CaWildlife_Center_2019`), size=5)+
  geom_point(aes(y=MMCCLA_2019), size=5)+
  geom_point(aes(y=`PMMC_2019`), size=5)+
  geom_point(aes(y=`SeaWorld_2019`), size=5)+
  scale_color_manual(
    labels=c("Mean Strandings Since 1998","The Marine Mammal Center","Ca Wildlife Center", "Marine Mammal Care Center LA", "Pacific Marine Mammmal Center", "SeaWorld"), 
    values =  c("grey0","red","Green","blue", "purple","orange"))
...
TMMC_Monthly_Plot_Legend = ggplot(TMMC_Monthly_Mean, aes(x= Month, y=Monthly_mean))+
  ...
  scale_color_manual(
    labels=c("Mean Strandings since 1998","The Marine Mammal Center","Ca Wildlife Center","Marine Mammal Care Center LA", "Pacific Marine Mammmal Center","SeaWorld"), values =c("grey0","red","green","blue","orange","purple"))
...
Cal_Poly_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/CPP_upload.csv") 
...
write_csv(Cal_Poly,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/CPP_cleanedup.csv")

#Newport  
Newport_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/NP_upload.csv") 
...
Newport = Newport_Org %>%
  mutate(Location = `Location Code`,
         ...
         Pn_seriata = `Pseudo-nitzschia seriata group (cells/L)`,
         Alexandrium = `Alexandrium spp. (cells/L)`,
         Domoic_Acid = `tDA (ng/mL)`) %>%
  select(Location, Date, Temperature, Chlorophyll, Nitrate, Phosphate, Silicate, Pn_delicatissima, Pn_seriata, Alexandrium,Domoic_Acid)%>% 
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Newport,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/NPP_cleanedup.csv")
...
Monterey = Monterey_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Monterey,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/MW_cleanedup.csv")

#Santa Cruz 
Santa_Cruz_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SCW.csv") 
...
Santa_Cruz = Santa_Cruz_Org %>% #353x10
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Santa_Cruz,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SCW_cleanedup.csv")

#Santa Monica  - No Silicate, listed as 'Dissolved Silicon'
Santa_Monica_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SMP_upload.csv")

Santa_Monica = Santa_Monica_Org %>% 
    mutate(Location = `Location Code`,
         Date = `Date Collected (YYYY_MM_DD)`,
         Temperature = `Temp (deg C)`,
         Chlorophyll =`Avg Chloro (mg/m3)`,
         Nitrate = `Nitrate (uM)`,
         Silicate= `Silicate (uM)`, 
...
write_csv(Santa_Monica,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SMP_cleanedup.csv")

#Stearns Wharf 
Stearn_Wharf_Org = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SW_upload.csv")

Stearn_Wharf = Stearn_Wharf_Org %>%
  mutate(Location = `Location Code`,
         Date = `Date Collected (YYYY-MM-DD)`,
         Temperature = `Temp (deg C)`,
         Chlorophyll =`Avg_Chloro`,
         Nitrate = `Nitrate`,
         Silicate= `Silicate`,
         Phosphate = `Phosphate`,
         Pn_delicatissima = `Pseudo_nitzschia_delicatissima_group`,
         Pn_seriata = `Pseudo_nitzschia_seriata_group`,
         Alexandrium = `Alexandrium_spp`,
         Domoic_Acid = `pDA`) %>%
  select(Location, Date, Temperature, Chlorophyll, Nitrate, Phosphate, Silicate, Pn_delicatissima, Pn_seriata, Alexandrium,Domoic_Acid)%>%
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"),
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Stearn_Wharf,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SW_cleanedup.csv")
...
Scripps_Pier = Scripps_Pier_Org %>%
  ...
  mutate(Year = format(as.Date(Date, format ="%Y-%m-%d"),"%Y"), #Silicate
         Month = format(as.Date(Date, format ="%Y-%m-%d"),"%m"),
         Day = format(as.Date(Date, format ="%Y-%m-%d"),"%d"))
write_csv(Scripps_Pier,"/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HABMAP_data/SP_cleanedup.csv")
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
...
save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
...
save_plot("Stearns_Wharf_Combo_Plot.png",Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
...
save_plot("Monterey_Pier_Combo_Plot.png",Monterey_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_04/HAB_plots")
```
Parsed with column specification:cols(
  Location = col_character(),
