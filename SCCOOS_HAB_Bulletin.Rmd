...
Pn_2019_07_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/2019_07_week_1_Pn.csv") 
Pn_2019_07_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/2019_07_week_2_Pn.csv") 
Pn_2019_07_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/2019_07_week_3_Pn.csv")
Pn_2019_07_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/2019_07_week_4_Pn.csv") 

CDPH_Pn_2019_07 = dplyr::bind_rows(Pn_2019_07_wk1, Pn_2019_07_wk2) 
CDPH_Pn_2019_07 = dplyr::bind_rows(CDPH_Pn_2019_07, Pn_2019_07_wk3) 
CDPH_Pn_2019_07 = dplyr::bind_rows(CDPH_Pn_2019_07, Pn_2019_07_wk4) 

#CDPH_Pn_2019_07 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/2019_07_Pn.csv")

CDPH_Pn_2019_07 = CDPH_Pn_2019_07 %>% #
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Pn_2019_07, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/CDPH_Pn_2019_07.csv")

CDPH_Pn_2019_07_max = CDPH_Pn_2019_07 %>%  
...
write_csv(CDPH_Pn_2019_07_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Pseudo_nitzschia/2019_07/CDPH_Pn_2019_07_max.csv")

Al_2019_07_wk1 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/2019_07_week_1_Al.csv")  
Al_2019_07_wk2 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/2019_07_week_2_Al.csv")  
Al_2019_07_wk3 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/2019_07_week_3_Al.csv")  
Al_2019_07_wk4 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/2019_07_week_4_Al.csv")  

CDPH_2019_07 = dplyr::bind_rows(Al_2019_07_wk1, Al_2019_07_wk2) 
CDPH_2019_07 = dplyr::bind_rows(CDPH_2019_07, Al_2019_07_wk3) 
CDPH_2019_07 = dplyr::bind_rows(CDPH_2019_07, Al_2019_07_wk4) 

#CDPH_2019_07 = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/2019_07_Al.csv")

CDPH_Al_2019_07 = CDPH_2019_07 %>%
  select(`Date -Sampled-`,`Sample Site`,`Percent Composition`,`Density -code-`,`RA Index`,Latitude,Longitude)

write_csv(CDPH_Al_2019_07, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/CDPH_Al_2019_07.csv")

CDPH_Al_2019_07_max = CDPH_Al_2019_07 %>% 
  group_by(`Sample Site`,Latitude,Longitude) %>%
  summarize(
    percent_composition_max = max(`Percent Composition`))%>%
  #arrange(Sample_Site) %>%
  arrange(percent_composition_max) #24x4
write_csv(CDPH_Al_2019_07_max, "/Volumes/GoogleDrive/My Drive/SCCOOS/CDPH/CDPH_Data/Alexandria/2019_07/CDPH_Al_2019_07_max.csv")
...
TMMC_Monthly_Mean = read_csv("~/Google Drive File Stream/My Drive/SCCOOS/CA_HAB_Bulletin/Stranding_Data/Data/TMMC_monthly_mean_1998-2018.csv")
#TMMC_Monthly_Mean = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/Stranding_Data/Data/TMMC_monthly_mean_1998-2018.csv")
...
ggsave(file="Stranding_Counts_2019_07.png", width=10, height =6 , path="~/Google Drive File Stream/My Drive/SCCOOS/CA_HAB_Bulletin/Stranding_Data/Plots")
...
HABMAP_Data = read_csv("/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HABMAP_data/HAB_2019_08_13.csv") 
...
HABMAP = HABMAP_Data %>%
  mutate(
    ...
    Domoic_Acid = pDA,
    Year = format(as.Date(Date_Collected, format ="%Y-%m-%d"),"%Y"))
...
Cal_Poly_HAB_Plot = 
  ...
  labs(title= "Cal Poly Pier HAB and DA Data", 
       ...
       color = "")+
  scale_x_date(
    limits = as.Date(c("2018-07-01","2019-07-31")),
...
save_plot("Cal_Poly_Combo_Plot.png", Cal_Poly_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")
...
Newport_Combo_Plot = plot_grid(Newport_HAB_Plot,Newport_DA_Pot, align="v",nrow=2, rel_heights = c(1, 4/5))

save_plot("Newport_Combo_Plot.png",Newport_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")

```

```{r Santa Cruz}

Santa_Cruz_HAB = HABMAP %>% #41x8
  filter(Location == 'SCW')%>%
  filter(Year %in% c("2018","2019"))%>% #Keep all 2018 and 2019 data 
  select(Date,Pn_delicatissima, Pn_seriata, Alexandrium, Domoic_Acid)%>%
  mutate(Pn_delicatissima = as.integer(Pn_delicatissima))
...
save_plot("Santa_Cruz_Combo_Plot.png", Santa_Cruz_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")
...
save_plot("Santa_Monica_Combo_Plot.png",Santa_Monica_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")

```

```{r Stearns Wharf}

Stearns_Wharf_HAB = HABMAP %>% 
  filter(Location == 'SW')%>%
  filter(Year %in% c("2018","2019"))%>% #Keep all 2018 and 2019 data 
  select(Date,Pn_delicatissima, Pn_seriata, Alexandrium, Domoic_Acid)%>%
  mutate(Domoic_Acid= as.double(Domoic_Acid),
         Pn_delicatissima = as.integer(Pn_delicatissima),
         Pn_seriata = as.integer(Pn_seriata))
...
save_plot("Stearns_Wharf_Combo_Plot.png", Stearns_Wharf_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")
...
Scripps_Pier_HAB_Plot = 
  ...
  #scale_y_continuous(labels = comma)+
  scale_x_date(
    limits = as.Date(c("2018-04-01","2019-04-31")),
    labels= date_format("%b %y"),
    date_breaks = "months")+
  theme_bw()+
  theme(
...
save_plot("Monterey_Pier_Combo_Plot.png",Monterey_Combo_Plot, base_width = 10, base_height = 8, path="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/2019_07/HAB_plots")
```
...
#21 variables
Shiny = HABMAP_Data %>%
  select(Location_Code, Date_Collected,Temp,Avg_Chloro, Avg_Phaeo,Phosphate, Silicate, Nitrite, Nitrate,Ammonium,pDA, Akashiwo_sanguinea, Alexandrium_spp, Ceratium, Cochlodinium,Gymnodinium_spp, Dinophysis_spp, Lingulodinium_polyedra, Prorocentrum_spp, Pseudo_nitzschia_delicatissima_group, Pseudo_nitzschia_seriata_group) %>%
  gather(key = "Observations", value = "Measurement","Temp","Avg_Chloro", "Avg_Phaeo","Phosphate", "Silicate", "Nitrite", "Nitrate","Ammonium","pDA", "Akashiwo_sanguinea", "Alexandrium_spp", "Ceratium", "Cochlodinium","Gymnodinium_spp", "Dinophysis_spp", "Lingulodinium_polyedra", "Prorocentrum_spp", "Pseudo_nitzschia_delicatissima_group", "Pseudo_nitzschia_seriata_group") %>%
  mutate(Date=Date_Collected)%>%
  select(Location_Code,Observations,Measurement,Date)

write_rds(Shiny, "HABMAP_Data2.rds")
...
HABMAP_lat_long = read_csv("HABMAP_Data/HABMAP_Sites.csv")
...
test1 = base.map <- ggplot() +
  geom_sf(data=states)+
  geom_point(data = HABMAP_lat_long,
             aes(Longitude, Latitude,  
                 color=Funder), #shape=Program # The shape palette can deal with a maximum of 6 discrete values
             size=4) + 
  xlab("Longitude") +
  ylab("Latitude") + 
...
ggsave(plot=test1, file="/Volumes/GoogleDrive/My Drive/SCCOOS/CA_HAB_Bulletin/HABMAP_Stations/HABMAP_Map.png", width=8, height = 8)

HABMAP.df = as.data.frame(HABMAP_lat_long)
l <- leaflet() %>%
  addProviderTiles(providers$Esri.OceanBasemap)

pal <- colorFactor(c("navy", "green"),
                   domain = unique(HABMAP_lat_long$Funder))

test4 = leaflet() %>% 
      addProviderTiles(providers$Esri.OceanBasemap) %>%
      addCircleMarkers(data=HABMAP_lat_long, 
                       color=~pal(Funder),
                       stroke= FALSE, fillOpacity = 0.5,
                       lng=~Longitude, 
                       lat=~Latitude,
                       label=paste(
                         HABMAP_lat_long$Sites, ",",
                         HABMAP_lat_long$Funder, ",")) 
test4
...
test3 = ca_base + theme_nothing() + 
  ...
  geom_point(data = HABMAP_lat_long,
             aes(Longitude, Latitude,  
                 color=Funder, group=Funder), #shape=Program # The shape palette can deal with a maximum of 6 discrete values
             size=4) +
  geom_text(data = HABMAP_lat_long, aes(x=Longitude, y=Latitude, label=Sites, group=Funder), hjust=0, nudge_x = 0.3)
  #coord_quickmap()
